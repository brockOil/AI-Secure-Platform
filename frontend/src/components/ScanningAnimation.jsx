    ...
    <div style={{
      ...
      <div style={{ position: "relative", width: size, height: size }}>
        ...
        <svg width={size} height={size} viewBox="0 0 120 120">
          ...
          {/* Cross hairs */}
          <line x1="40" y1="60" x2="50" y2="60" stroke="rgba(0,255,157,0.2)" strokeWidth="0.5" />
          <line x1="70" y1="60" x2="80" y2="60" stroke="rgba(0,255,157,0.2)" strokeWidth="0.5" />
          <line x1="60" y1="40" x2="60" y2="50" stroke="rgba(0,255,157,0.2)" strokeWidth="0.5" />
          <line x1="60" y1="70" x2="60" y2="80" stroke="rgba(0,255,157,0.2)" strokeWidth="0.5" />
        </svg>
      </div>
